...
<body class="guide-page dining-guide" data-guide="where-to-eat-seoul-by-budget">
  ...
  <main id="top">
    ...
    <div class="restaurant-guide-content">
      ...
      <aside class="booking-panel" id="affiliate-booking"><div><p class="eyebrow">Want more context?</p><h3>Compare Seoul food tours and activities.</h3><p>A good tour can help with markets, ordering and local food history. Booking through an affiliate link may support Korea RouteCheck at no extra cost.</p></div><div class="booking-links"><a data-affiliate="experiences" href="#">Compare Seoul food tours and activities <span>→</span></a></div></aside>
      <section class="source-section" id="sources"><p class="eyebrow">Before visiting</p><h2>Check the listing again</h2><p>Restaurants can change prices, hours, branches and queue systems. Open the Naver Maps link before leaving, and make sure the name and branch match this guide.</p></section>
    </div>
  </main>
  <footer><div><strong>Korea RouteCheck</strong><p>Practical Seoul itineraries and travel guides.</p></div><div class="footer-links"><a href="index.html#planner">Planner</a><a href="index.html#guides">Itineraries</a><a href="disclosure.html">Affiliate disclosure</a><a href="privacy.html">Privacy</a></div><p class="copyright">© <span id="year"></span> Korea RouteCheck. Verify current travel information before booking.</p></footer>

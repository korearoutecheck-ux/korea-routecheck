...
const guides = [
  {
    ...
    kicker: "A useful day in the rain",
    title: "A rainy-day Seoul itinerary that still feels like Seoul",
    seoTitle: "Rainy Day in Seoul: A Practical Indoor Itinerary",
    description: "A rainy-day Seoul itinerary with indoor options in Jamsil, Yongsan and COEX and fewer outdoor transfers.",
    lede: "Choose one area with several indoor options. That keeps the day simple and leaves room for a short outdoor walk if the weather improves.",
    chips: ["One indoor district", "Short exposed transfers", "Budget alternatives"],
    facts: [["Best all-day area", "Jamsil"], ["Best low-cost option", "National Museum"], ["Best compact backup", "COEX"], ["Avoid", "Cross-city trips"]],
    note: "Do not prepay for a skyline view in heavy cloud. Decide later and use an aquarium, museum or shopping complex as the main plan.",
    sections: [
      { id: "route", eyebrow: "Full-day plan", title: "An indoor day in Jamsil", intro: "Jamsil's main attractions connect through one large complex. Add a short lake walk only if the rain eases.", cards: [
      ...
      { id: "alternatives", eyebrow: "Choose by budget", title: "Other indoor options", intro: "Choose a museum or central area when a mall does not fit the trip.", cards: [
        ["Yongsan and Ichon", "Start at the National Museum of Korea, where the permanent collection has free general admission. Eat nearby, then continue in Yongsan or Hannam."],
        ["Samseong and COEX", "Visit COEX, Starfield Library and one paid indoor attraction. Add Bongeunsa during a dry window, but leave Jamsil for another day."],
      ...
      { id: "prepare", eyebrow: "Stay comfortable", title: "Simple rain-day tips", intro: "Wet shoes, long transfers and fixed reservations cause most rain-day problems.", cards: [
        ["Keep feet dry", "A compact umbrella helps, but waterproof footwear or spare socks often matters more."],
  ...
  },
  {
    ...
    sections: [
      { id: "base", eyebrow: "Where to stay", title: "Three easy bases for a solo trip", intro: "Choose by sightseeing, nightlife or airport access.", cards: [
      ...
      { id: "route", eyebrow: "A complete solo day", title: "Jongno at a flexible pace", intro: "This route is easy to shorten, extend or pause without affecting another traveler. It also provides a mix of public sights, cafes and active streets.", cards: [
        ...
        ["Afternoon", "Move east through Insadong, galleries and tea houses. These places are comfortable to visit alone and easy to enjoy at any pace."],
        ["Evening", "Finish in Ikseon-dong or Cheonggyecheon. For a livelier night, rest at the hotel before going to Hongdae."]
      ]},
      { id: "practical", eyebrow: "Comfort and safety", title: "Small habits that make solo travel easier", intro: "Seoul is navigable, but the same big-city habits still apply—especially after the last trains, in nightlife areas and when a phone battery is low.", cards: [
        ...
        ["Choose social activities carefully", "Food tours, cooking classes and guided day trips can make it easier to meet people. One or two is usually enough."],
  ...
  },
  {
    ...
    lede: "Immigration, baggage and the airport transfer often take longer than expected. Stay near the hotel and keep every first-day stop optional.",
    chips: ["Arrival-time options", "Jet-lag aware", "No rigid reservations"],
    facts: [["First step", "Reach the hotel area"], ["Best activity", "A neighborhood walk"], ["Booking rule", "Keep the evening flexible"], ["Avoid", "Crossing the city"]],
    ...
    sections: [
      { id: "arrival", eyebrow: "Choose by arrival time", title: "Day-one plans by arrival time", intro: "Use the time you reach the hotel, not the flight's scheduled landing time.", cards: [
        ...
        ["At the hotel from noon to 4 p.m.", "Choose one area: Myeongdong and Namsan, Hongdae and Yeonnam, or Jongno and Ikseon-dong. Treat sunset as optional."],
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "compare", eyebrow: "Compare your options", title: "Train, bus or taxi?", intro: "Choose based on the full trip to the hotel.", cards: [
        ["AREX Express", "Best for Seoul Station or a simple onward trip. Reserved seats and fewer stops help, but a difficult final subway transfer can remove the advantage."],
  ...
  },
  {
    ...
    chips: ["Seven neighborhoods", "Pros and cons", "Short-trip recommendations"],
    ...
    sections: [
      { id: "central", eyebrow: "The easiest first choices", title: "Central Seoul", intro: "These areas place palaces, markets, Myeongdong and Namsan within short transit distances and work especially well for two- to five-day visits.", cards: [
        ["Jongno", "Best for history, early palace starts and traditional neighborhoods. Some streets are quiet at night, and hotel quality varies by block."],
        ["Myeongdong", "Best for convenience, shopping and central transit. It is busy and commercial rather than quiet or residential."],
        ["Euljiro", "Best for restaurants and several subway lines. The older commercial streets can be harder to read at first than Myeongdong."]
      ]},
      { id: "character", eyebrow: "Choose a stronger personality", title: "Neighborhoods with a specific advantage", intro: "These bases work when their defining strength matters enough to accept longer trips to other parts of Seoul.", cards: [
        ...
        ["Itaewon and Hannam", "Best for international dining, museums and evening variety. Expect hills and longer trips to some major sights."],
  ...
  },
  {
    ...
    chips: ["Independent and guided options", "Pros and cons", "First-trip priorities"],
    ...
    sections: [
      { id: "compare", eyebrow: "The shortlist", title: "Five realistic day-trip choices", intro: "Each option earns the full day for a different reason. Avoid combining destinations simply because package tours advertise them together.", cards: [
        ...
        ["Nami Island and Garden of Morning Calm", "Best for seasonal landscapes, couples and photography. A combined tour can make the transfers easier."],
      ...
      { id: "booking", eyebrow: "Book carefully", title: "Day-trip booking rules", intro: "A day outside Seoul introduces more dependency on weather, operating conditions and transport timing.", cards: [
        ...
        ["Leave room the next morning", "Do not schedule a late-return day trip before an early flight, palace reservation or another long excursion."],
...
function relatedMarkup(currentSlug) {
  return related.filter(item => item.slug !== currentSlug).slice(0, 3).map(item => `<a class="guide-card" href="${item.slug}.html"><span>Travel guide</span><h3>${item.label}</h3><p>${item.description}</p><strong>Read the guide →</strong></a>`).join("\n");
}
...
function page(guide) {
  ...
  const extraHelp = {
    "rainy-day-seoul-itinerary": '<aside class="context-links"><p><strong>Want one activity to anchor the day?</strong> Compare <a href="seoul-cooking-classes.html">Seoul cooking classes by menu and location</a>. Check whether your choice includes an outdoor market visit before treating it as an entirely indoor plan.</p></aside>',
    "seoul-solo-travel-guide": '<aside class="context-links"><p><strong>Food on your own or with a group?</strong> Use the <a href="gwangjang-market-food-guide.html">Gwangjang Market food guide</a> for a flexible solo stop, or compare <a href="seoul-cooking-classes.html">cooking classes with a shared meal</a>.</p></aside>'
  }[guide.slug] || '<aside class="context-links"><p>Once you know your route, <a href="seoul-tours.html">find a Seoul tour by interest and available time</a>. Keep any booking close to the rest of your day.</p></aside>';
  const articleSchema = {
    ...
    "@graph": [
      articleSchema,
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Seoul travel guides", item: `${siteBase}/#planning-guides` },
...
<body class="guide-page" data-guide="${guide.slug}">
  ...
  <header class="site-header"><a class="brand" href="index.html" aria-label="Korea RouteCheck home"><img class="brand-mark" src="favicon.svg?v=krc1" width="44" height="44" alt=""><span>Korea RouteCheck</span></a><nav aria-label="Primary navigation"><a href="index.html#planner">Planner</a><a href="index.html#guides">Itineraries</a><a href="index.html#where-to-eat">Where to eat</a><a href="seoul-tours.html">Tours</a><a href="#related">Travel guides</a></nav></header>
  ...
  <footer><div><strong>Korea RouteCheck</strong><p>Practical Seoul itineraries and travel guides.</p></div><div class="footer-links"><a href="index.html#planner">Planner</a><a href="where-to-eat-seoul-by-budget.html">Where to eat</a><a href="seoul-tours.html">Tour guides</a><a href="about.html">About</a><a href="disclosure.html">Affiliate disclosure</a><a href="privacy.html">Privacy</a></div><p class="copyright">© <span id="year"></span> Korea RouteCheck. Verify current travel information before booking.</p></footer>
